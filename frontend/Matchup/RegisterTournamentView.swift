...
struct RegisterTournamentView_Previews: PreviewProvider {
    static var previews: some View {
        RegisterTournamentView(tournament: Tournament(id: 1, name: "Sample", formatSize: 3, maxTeams: 16, entryFeeCents: nil, depositHoldCents: nil, currency: "CAD", prizeCents: nil, signupDeadline: Date(), startsAt: Date(), endsAt: nil, location: "Some Gym", status: .signupsOpen, createdBy: 1))
    }
}
